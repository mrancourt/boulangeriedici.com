            ...
            <div className="columns">
              <div className="column col-lg-12">
                ...
                <div className="point-of-sale">
                  ...
                  <p className="address">12755 36<sup>e</sup> Avenue</p>
                </div>
                ...
                <div className="point-of-sale">
                  ...
                  <p className="address">911 150<sup>e</sup> Rue</p>
                </div>

                <div className="point-of-sale">
                  <p className="title">Le Jardin des Sages</p>
                  <p className="address">10435 1<sup>e</sup> Avenue</p>
                </div>

                <div className="point-of-sale">
                  <p className="title">Le Grand Marché</p>
                  <p className="address">12120, 1<sup>e</sup> Avenue</p>
                </div>
                ...
                <div className="point-of-sale">
                  ...
                  <p className="address">2600-2798 25<sup>e</sup> Avenue</p>
                </div>
              </div>
              <div className="column col-lg-12">
                <p className="location">
                ...
                <div className="point-of-sale">
                  ...
                  <p className="address">713, 15<sup>e</sup> Rue</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="columns">
              <div className="column col-lg-12">
                ...
                <div className="point-of-sale">
                  ...
                  <p className="address">11780 1<sup>e</sup> Avenue</p>
                </div>
              </div>
